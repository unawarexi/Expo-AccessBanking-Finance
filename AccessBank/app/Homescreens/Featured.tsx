  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.featuredSection}>
        ...
        {/* Slider */}
        <ScrollView horizontal pagingEnabled showsHorizontalScrollIndicator={false} onScroll={handleScroll} scrollEventThrottle={16} style={styles.slider}>
        ...
        <View style={styles.indicatorContainer}>
          {featuredItems.map((_, index) => (
            <View key={index} style={[styles.indicator, { backgroundColor: activeSlide === index ? '#1E3A8A' : '#93C5FD' }]} />
          ))}
        </View>
      </View>
    </View>
